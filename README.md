...
[MyraMusic](https://github.com/TEAMSTARWORLD/MyraMusic) is a Powerful Telegram Music+Video Bot written in Python using Pyrogram and Py-Tgcalls by which you can stream songs, video and even live streams in your group calls via various sources.
...
### Before deploying MyraMusic , please have a look towards [all available config vars](../config/README.md) , also please check [all available commands](../strings/command.yml) of the project.
...
<h4>Click the button below to deploy MyraMusic on Heroku!</h4>    
<a href="https://dashboard.heroku.com/new?template=https://github.com/TEAMSTARWORLD/MyraMusic"><img src="https://img.shields.io/badge/Deploy%20To%20Heroku-blueviolet?style=for-the-badge&logo=heroku" width="200""/></a>
...
```console
shikhar@MacBook~ $ git clone https://github.com/TEAMSTARWORLD/MyraMusic
shikhar@MacBook~ $ cd MyraMusic
...
<img src="https://telegra.ph/file/7f02aa286e32036dbd271.jpg" align="center">
...
- [Updates Channel](https://telegram.me/TEACH_TEAMOP)
- [Support Group](https://telegram.me/MYRAOFFICIAL)

## 🎗 Project assistance

If you want to say **thank you** or/and support active development of MyraMusic:

- Add a [GitHub Star](https://github.com/TEAMSTARWORLD/MyraMusic) to the project.
- Fork the Repo :)
